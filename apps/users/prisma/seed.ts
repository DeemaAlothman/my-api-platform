...
async function main() {
  ...
  const permissions = [
    ...
    { name: 'attendance.records.create-manual', displayName: 'تسجيل يدوي للحضور', module: 'attendance' },
    { name: 'attendance.records.update', displayName: 'تعديل سجل حضور', module: 'attendance' },
    { name: 'attendance.records.update-manual', displayName: 'تعديل يدوي للحضور', module: 'attendance' },
