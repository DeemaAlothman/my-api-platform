...
ON CONFLICT (name) DO NOTHING;
  ...
  const rolePermissions: Record<string, string[]> = {
    clinic_reception: [
      ...
      'clinic.podiatry.reception.create',
      'clinic.podiatry.reception.edit',
      'clinic.podiatry.session.create',
      'clinic.podiatry.session.edit',
      'clinic.podiatry.session.archive',
