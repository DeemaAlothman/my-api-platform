...
export enum AppointmentTypeEnum {
  ...
  TRIAL_DELIVERY         = 'TRIAL_DELIVERY',
  FINAL_DELIVERY         = 'FINAL_DELIVERY',
  REVIEW                 = 'REVIEW',
  IMPRESSION_TAKING      = 'IMPRESSION_TAKING',
  MEASUREMENT_TAKING     = 'MEASUREMENT_TAKING',
  WHEELCHAIR_DELIVERY    = 'WHEELCHAIR_DELIVERY',
  WARRANTY_DELIVERY      = 'WARRANTY_DELIVERY',
  COSMETIC_DELIVERY      = 'COSMETIC_DELIVERY',
  ANALYSIS               = 'ANALYSIS',
  INSTALLATION           = 'INSTALLATION',
  // الإدارة الطبية (المعاينات العظمية)
  ORTHOPEDIC_EXAMINATION   = 'ORTHOPEDIC_EXAMINATION',
  FOOT_ANALYSIS_EXAMINATION = 'FOOT_ANALYSIS_EXAMINATION',
  LIMB_PATIENT_EXAMINATION  = 'LIMB_PATIENT_EXAMINATION',
}
