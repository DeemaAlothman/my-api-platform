...
export class CasesController {
  ...
  @Post(':id/assessment-transtibial')
  @Permission(PERMISSIONS.CLINIC_PROSTHETICS.ASSESSMENT_CREATE)
  ...
  @Post(':id/assessment-transradial')
  @Permission(PERMISSIONS.CLINIC_PROSTHETICS.ASSESSMENT_CREATE)
  upsertTransradial(@Param('id') id: string, @Body() dto: TransradialAssessmentDto) {
    return this.service.upsertTransradialAssessment(id, dto);
  }

  @Post(':id/assessment-elbow-disarticulation')
  @Permission(PERMISSIONS.CLINIC_PROSTHETICS.ASSESSMENT_CREATE)
  ...
  @Get(':id/alerts')
  @Permission(PERMISSIONS.CLINIC_PROSTHETICS.CASE_VIEW)
  getCaseAlerts(@Param('id') id: string) {
    return this.service.getCaseAlerts(id);
  }

  @Post(':id/alerts/:alertId/respond')
  @Permission(PERMISSIONS.CLINIC_PROSTHETICS.GAIT_CREATE)
  respondToCaseAlert(
    @Param('id') id: string,
    ...
    return this.service.respondToCaseAlert(id, alertId, body.note);
  }
  ...
  createFinalDelivery(@Param('id') id: string, @Body() dto: FinalDeliveryFormDto, @User() user: any) {
    return this.service.createFinalDelivery(id, dto, user.userId, user.fullName);
  }
