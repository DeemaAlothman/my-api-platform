CREATE TABLE clinic_prosthetics.knee_disarticulation_assessments (
  "id"                     TEXT NOT NULL,
  ...
  CONSTRAINT "knee_disarticulation_assessments_pkey" PRIMARY KEY ("id"),
  CONSTRAINT "knee_disarticulation_assessments_caseId_side_key" UNIQUE ("caseId", "side"),
  CONSTRAINT "knee_disarticulation_assessments_caseId_fkey"
    FOREIGN KEY ("caseId")
