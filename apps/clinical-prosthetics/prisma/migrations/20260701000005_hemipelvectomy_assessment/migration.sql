CREATE TABLE clinic_prosthetics.hemipelvectomy_assessments (
  "id"                     TEXT NOT NULL,
  ...
  CONSTRAINT "hemipelvectomy_assessments_pkey" PRIMARY KEY ("id"),
  CONSTRAINT "hemipelvectomy_assessments_caseId_side_key" UNIQUE ("caseId", "side"),
  CONSTRAINT "hemipelvectomy_assessments_caseId_fkey"
    FOREIGN KEY ("caseId")
