...
export enum PhysioPainType { NUMBNESS = 'NUMBNESS', DULL_ACHE = 'DULL_ACHE', HOT_BURNING = 'HOT_BURNING', SHARP_STABBING = 'SHARP_STABBING', PINS = 'PINS', NORMAL = 'NORMAL', OTHER = 'OTHER' }
